...
%>
<link href="${path }/front/css/book_head090107.css" rel="stylesheet"
      type="text/css"/>
<div class="head_container">
    <div class="head_welcome">
		...
		<c:if test='${user.nickname!=null}'>
            <b>您好，${user.nickname}欢迎光临当当网</b>
            [&nbsp;<a href="${path}/user/user_safeOut" class="b">退出</a>&nbsp;]
        </c:if>
    ...
    <div class="head_head_list">
        <div class="head_head_list_left">
			<span class="head_logo"> <a href="${path }/fmain/fmain_showAllInformation" name="backtobook"> <img
                    src="${path }/front/images/booksaleimg/book_logo.gif"/>
			</a>
			</span>
        </div>
